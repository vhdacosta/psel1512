...
def main():
  ...
  # Removemos os calçados que não serão mais vendidos, 
  # OBS.: É utilizado o "ados" pois não consegui resolver o problema da minha máquina de não reconhecer Ç nas funções do BeautifulSoup.
  remove_products(soup, product_type="ados")

  # Para arrumar as tags de título (title) dos ids que estão errados, podemos usar a função abaixo que utiliza os dados 'id' e 'title' da lista products para corrigir.
